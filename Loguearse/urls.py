...
urlpatterns = [
    ...
    path('Login/Complete', views.LoginComplete),
    
    #path('password_reset/', auth_views.PasswordResetView.as_view(template_name='password_change.html',html_email_template_name='password_reset_email.html'),name='password_reset'),
